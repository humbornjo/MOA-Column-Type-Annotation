...
if version.parse(transformers.__version__) < version.parse("4.1.1"):
    ...
    from transformers.models.bert.modeling_bert import BertEmbeddings, BertEncoder, BertModel
