...
if __name__ == "__main__":
    ...
    for task in args.tasks:
        ...
        if task in [
            ...
            if args.single_col and args.lpnembed:
                dataset_cls = LpnembedSatoCVTablewiseDataset
            elif args.single_col:
            ...
            if args.single_col and args.lpnembed:
                dataset_cls = LpnembedTURLColTypeColwiseDataset
            elif args.single_col:
                if args.single_col:
    ...
    if args.cl: 
        ...
        pre_cl_dataset = SatoCVColwiseDataset(cv=cv,
                                    split="train",
                                    tokenizer=tokenizer,
                                    max_length=max_length,
                                    multicol_only=multicol_only,
        ...
        for epoch in range(20):
            ...
            for batch_idx, batch in enumerate(cl_dataloader):
                cl_model.train()
                ...
                loss.backward()
                cl_optimizer = AdamW(params = cl_model.parameters(), lr=3e-6, eps=1e-8)
